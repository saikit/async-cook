# Weekday Rice and Lentils

A dish inspired by the Middle Eastern dish mujadara that is ready as soon as the rice and lentils are done cooking, though it does require attention of two separate pans at the stove.
...
- **2g** ground cumin
- **2g** ground coriander
- **2g** dried mint (Recommendation: Use 5g of fresh mint if available)
- lemon zest
- salt
...
- For the caramelized onions, peel and dice one **onion**.

- For the crispy onions, peel and cut **onion** into thin slices.

- Slice **scallions** if using
...
When caramelized  are cooked to the desired sweetness, add **cumin seeds** (and **sliced scallions** if using) to pan and cook for another 30 seconds. Mix **caramelized onions** and cumin to **rice and lentils**. Top the dish with crispy onions and the **onion-infused oil**.
