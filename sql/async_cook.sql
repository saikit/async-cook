...
--
-- Host: mysql
-- Generation Time: Dec 05, 2025 at 09:20 PM
...
(18, 76, NULL, 'recommendation', 'Dried shiitake mushrooms are traditional, but any dried or fresh mushrooms will work.'),
...
INSERT INTO `ingredients` (`id`, `recipe_id`, `name`, `fdc_id`, `cooked`, `optional`, `step`, `ing_order`) VALUES
(1, 1, '**340-450g** cherry tomatoes', 2023153, 0, NULL, 1, 1),
(2, 1, '**3-4** unpeeled cloves of garlic', NULL, 0, NULL, 1, 2),
(3, 1, '**30g** extra virgin olive oil', 748608, 0, NULL, 1, 3),
(4, 1, 'salt', NULL, 0, NULL, 1, 4),
(5, 1, 'black pepper', NULL, 0, NULL, 1, 5),
(6, 1, '**120g** raw shrimp', 2684443, 0, NULL, 2, 1),
(7, 1, 'salt', NULL, 0, NULL, 2, 2),
(8, 1, 'a pinch of baking soda', NULL, 0, NULL, 2, 3),
(9, 1, '**120g** mozzarella cheese', 170846, 0, NULL, 3, 1),
(10, 1, '**150g** dried pasta', 169736, 0, NULL, 4, 1),
(11, 1, '**600ml** water', NULL, 0, NULL, 4, 2),
(12, 1, 'salt', NULL, 0, NULL, 4, 3),
(13, 1, 'seasoned shrimp', NULL, 1, NULL, 5, 1),
(14, 1, 'dried basil', NULL, 0, NULL, 6, 1),
(15, 1, 'red pepper flakes', NULL, 0, NULL, 6, 2),
(16, 1, 'cooked pasta', NULL, 1, NULL, 6, 3),
(17, 1, 'cooked pasta water', NULL, 1, NULL, 6, 4),
(18, 1, '**20g** grated Parmesan cheese', NULL, 0, NULL, 6, 5),
(19, 1, 'black pepper', NULL, 0, NULL, 6, 6),
(20, 1, 'extra virgin olive oil', NULL, 0, NULL, 6, 7),
(21, 1, 'salt or fish sauce', NULL, 0, NULL, 6, 8),
(34, 1, 'cooked shrimp', NULL, 1, 'Shrimp', 6, 9),
(35, 1, 'extra grated Parmesan cheese *(for serving)*', NULL, 0, NULL, 7, 1),
(36, 1, 'sliced mozzarella', NULL, 1, 'Mozzarella', 7, 2),
(37, 2, '**200g** lettuce\r\n', 169247, 0, NULL, 1, 1),
(38, 2, '**1** scallion\r\n', NULL, 0, NULL, 1, 2),
(39, 2, '**3** cloves garlic', NULL, 0, NULL, 1, 3),
(40, 2, '**20g** oyster sauce\r\n', NULL, 0, NULL, 2, 1),
(43, 2, '**10ml** soy sauce', NULL, 0, NULL, 2, 2),
(44, 2, '**2g** sugar', NULL, 0, NULL, 2, 3),
(45, 2, '**2g** dark soy sauce', NULL, 0, NULL, 2, 4),
(46, 2, 'a sprinkle of MSG *(optional)*\r\n', NULL, 0, NULL, 2, 5),
(47, 2, '**1** **5oz** can of chunk light tuna, undrained', 175158, 0, NULL, 2, 6),
(48, 2, '**1g** cornstarch', NULL, 0, NULL, 3, 1),
(49, 2, '**20ml** water\r\n', NULL, 0, NULL, 3, 2),
(50, 2, '**500ml** water', NULL, 0, NULL, 4, 1),
(51, 2, '**10g** salt', NULL, 0, NULL, 4, 2),
(52, 2, '**10g** neutral cooking oil', NULL, 0, NULL, 5, 1),
(53, 2, 'minced garlic', NULL, 1, NULL, 5, 2),
(54, 2, 'chopped scallion', NULL, 1, NULL, 5, 3),
(55, 2, 'red pepper flakes', NULL, 0, NULL, 5, 4),
(56, 2, 'chopped lettuce', NULL, 1, NULL, 6, 1),
(57, 2, 'finished sauce', NULL, 1, NULL, 7, 2),
(58, 2, 'cooked lettuce', NULL, 1, NULL, 7, 1),
(59, 4, '**225g** dried pinto beans', 747445, 0, NULL, 1, 1),
(60, 4, '**300-400g** sweet potato', 2346404, 0, NULL, 2, 1),
(65, 4, '**1** avocado', 2710824, 0, NULL, 3, 1),
(66, 4, 'extra virgin olive oil', NULL, 0, NULL, 4, 3),
(67, 4, 'red wine vinegar', NULL, 0, NULL, 4, 4),
(68, 4, 'black pepper', NULL, 0, NULL, 4, 5),
(69, 4, 'Tajín seasoning *(optional)*', NULL, 0, NULL, 4, 6),
(70, 4, 'cooked beans', NULL, 1, NULL, 4, 1),
(71, 4, 'sliced avocado', NULL, 1, NULL, 5, 1),
(72, 3, '**150g** split mung beans', 174256, 0, NULL, 1, 1),
(73, 3, '**150g** rice', 2512381, 0, NULL, 1, 2),
(74, 3, '**485g** water', NULL, 0, NULL, 1, 3),
(75, 3, '**15g** soy sauce *(optional)*', NULL, 0, NULL, 1, 4),
(76, 3, '**80g** mushrooms', 1999628, 0, NULL, 2, 1),
(77, 3, '**80g** Chinese sausage', 2066352, 0, NULL, 3, 1),
(78, 3, 'rice and mung beans mixture', NULL, 1, NULL, 4, 1),
(79, 3, '**15g** lard or butter', 789828, 0, NULL, 5, 2),
(80, 4, '**900g** water', NULL, 0, NULL, 1, 2),
(81, 4, '**5g** salt', NULL, 0, NULL, 1, 3),
(82, 4, '**1g** baking soda *(optional)*', NULL, 0, NULL, 1, 4),
(83, 3, 'cooked rice and beans', NULL, 1, NULL, 5, 1),
(84, 4, 'roasted sweet potatoes', NULL, 1, NULL, 4, 2);
...
(31, 3, 5, 'Add fats', 'Mix **cooked rice and beans** with **lard or butter** before serving.', NULL, 'Fats', 1);
