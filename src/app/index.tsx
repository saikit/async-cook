...
function Index() {
    ...
    <main className='p-4'>
        ...
        <h2 className='text-xl mb-4'>Async Cook is an App for mobile devices and tablets and a cookbook for home cooks with easy-to-follow recipes. App and recipes developed by <Link className='underline text-blue-700 whitespace-nowrap' to="https://www.saikithui.com" target='_blank'>Sai-Kit Hui</Link></h2>
